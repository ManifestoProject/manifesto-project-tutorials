...
readable <- coverage_manifesto_count %>%
  ...
  labs(title="Machine-readable documents of the Manifesto Corpus", caption="Share of machine-readable documents relative to the number of documents covered by the Main Dataset", x="", y="")
print(readable)
...
annotated <- coverage_manifesto_count %>%
  ...
  #scale_fill_discrete(guide = "none")+
  scale_x_date(date_breaks = "10 years", date_labels = "%Y", limits = (c(1916, 2020) %>% paste0("0101") %>% as.Date("%Y%m%d"))) +
  labs(title="Share of annotated documents in the Manifesto Corpus", caption="Share of annotated documents relative to the number of documents covered by the Main Dataset", x="", y="")
print(annotated)
```
